import { filterProcedureLegs } from "./procedure-filter-procedure-legs.js";
import {
...
export function buildProcedureRenderModel(procedureResult, options = {}) {
  ...
  for (const leg of legs) {
    ...
    if (annotationFeature) annotationFeatures.push(annotationFeature);
    ...
    editorialFeatures.push(...derivedEditorialFeatures);
  }
